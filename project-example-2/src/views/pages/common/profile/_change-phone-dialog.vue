      ...
      >
        ...
        <section class="modal-card-body">
          ...
          >
            <b-input
              ...
              :disabled="isFirstFormProcessing"
              :placeholder="
                $t('block-global.new-phone-confirmation-placeholder')
              "
        ...
        <footer class="modal-card-foot">
          ...
          <button
            :class="[
              'button is-primary',
              { 'is-loading': isFirstFormProcessing }
            ]"
          >
            <span class="icon">
      ...
      >
        ...
        <footer class="modal-card-foot">
          ...
          <button
            :class="[
              'button is-primary',
              { 'is-loading': isSecondFormProcessing }
            ]"
          >
            <span class="icon">
              <i class="mdi mdi-check"></i>
...
export default {
  ...
  computed: {
    ...
    phoneConfirmErrorMessages() {
      ...
      if (!this.$v.confirmPhone.required)
        errors.push(this.$t("block-errors.field-is-required"));
      if (!this.$v.confirmPhone.sameAsPassword)
        errors.push(this.$t("block-errors.change-phone.phone-not-equal"));

      return errors;
    },

    firstFormErrorsMessages() {
      return this.firstFormErrors.map(item =>
        this.$t(`block-errors.change-phone.${item}`)
      );
    },
    ...
    secondFormErrorsMessages() {
      return this.secondFormErrors.map(item =>
        this.$t(`block-errors.change-phone.${item}`)
      );
    }
  },
