  ...
  <nav class="navbar">
    <div class="navbar-menu">
      <div class="navbar-start">
        <div class="control">
          <b-input
            :placeholder="$t('page-admin-leads.searching')"
            type="search"
            icon="magnify"
            @input="search"
          >
      ...
      <div class="navbar-end">
        <div class="field is-grouped">
          <div class="control">
            ...
            >
              <button class="button is-primary" type="button" slot="trigger">
                <span>{{ $t('page-admin-leads.show-columns',
          ...
          <div class="control">
            ...
            >
              <button class="button is-primary" type="button" slot="trigger">
                <span v-if="perPageValue === -1">{{ $t('page-admin-leads.show-all') }}</span>
                <span v-else>{{ $t('page-admin-leads.show-per-page',
              ...
              <b-dropdown-item
                ...
                :key="key"
              >
                <span v-if="item.value === -1">{{ $t('page-admin-leads.show-all') }}</span>
                <span v-else>{{ $t('page-admin-leads.show-per-page',
